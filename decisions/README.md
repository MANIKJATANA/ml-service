...
- [0019 — Dev-only browser test UI for enroll + identify](0019-dev-test-ui.md) — flag-gated `GET /test` page + `/v1/test/{enroll,check}` reusing the real container; adds a media-store `upload` helper; `ML_ENABLE_TEST_UI`.
